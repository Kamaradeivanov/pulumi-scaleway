...
class VolumeAttachment(pulumi.CustomResource):
    ...
    """
    volume: pulumi.Output[str]
    """
    the volume to attach
    """
    def __init__(__self__, resource_name, opts=None, server=None, volume=None, __props__=None, __name__=None, __opts__=None):
        """
        Create a VolumeAttachment resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[str] server: the server a volume should be attached to
        :param pulumi.Input[str] volume: the volume to attach
        """
    ...
    @staticmethod
    def get(resource_name, id, opts=None, server=None, volume=None):
        """
