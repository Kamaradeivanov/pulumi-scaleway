...
export class LbFrontendBeta extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LbFrontendBetaState, opts?: pulumi.CustomResourceOptions): LbFrontendBeta {
        return new LbFrontendBeta(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'scaleway:index/lbFrontendBeta:LbFrontendBeta';

    /**
     * Returns true if the given object is an instance of LbFrontendBeta.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is LbFrontendBeta {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === LbFrontendBeta.__pulumiType;
    }

    /**
     * ACL rules
     */
    public readonly acls!: pulumi.Output<outputs.LbFrontendBetaAcl[] | undefined>;
    /**
    ...
    /**
     * Create a LbFrontendBeta resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: LbFrontendBetaArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: LbFrontendBetaArgs | LbFrontendBetaState, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (opts && opts.id) {
            const state = argsOrState as LbFrontendBetaState | undefined;
            ...
            const args = argsOrState as LbFrontendBetaArgs | undefined;
        ...
        super(LbFrontendBeta.__pulumiType, name, inputs, opts);
    }
}
 ...
 */
export interface LbFrontendBetaState {
    /**
     * ACL rules
     */
    readonly acls?: pulumi.Input<pulumi.Input<inputs.LbFrontendBetaAcl>[]>;
    /**
     * The load-balancer backend ID
     */
 ...
 */
export interface LbFrontendBetaArgs {
    /**
     * ACL rules
     */
    readonly acls?: pulumi.Input<pulumi.Input<inputs.LbFrontendBetaAcl>[]>;
